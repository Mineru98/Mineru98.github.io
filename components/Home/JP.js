...
const Japanese = {
	...
	DBJava_Title: 'Javaによる辞書ランダム',
	DBJava_Date: '2020年1月31日から配布',
	DBJava_Description: '確率が配列にあらかじめ指定されているアルゴリズムは、その確率で結果を抽出します。',
};
							...
							<Grid.Row columns={4}>
								<Grid.Column>
									...
									>
										...
										<Card.Content>
											<Card.Header id="default">
												{Japanese.DBJava_Title}
											</Card.Header>
											<Card.Meta>
												<span className="date">
													{Japanese.DBJava_Date}
												</span>
											</Card.Meta>
											<Card.Description id="default">
												{Japanese.DBJava_Description}
											</Card.Description>
										</Card.Content>
										<Card.Content extra>
											<Label as="a" image>
								...
								<Grid.Column>
									<Card href="https://github.com/Mineru98/Fibonacci-Even-Sum" id="card">
										...
										<Card.Content extra>
											...
											<Label as="a" image>
												<Image src="/static/imgs/icon_algorithm.png" /> Desktop App
											</Label>
										</Card.Content>
									</Card>
								</Grid.Column>
