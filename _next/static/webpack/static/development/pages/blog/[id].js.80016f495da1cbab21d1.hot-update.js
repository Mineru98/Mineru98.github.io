...
class Tag extends react__WEBPACK_IMPORTED_MODULE_0___default.a.Component {
  ...
  UNSAFE_componentWillMount() {
    console.log(next_router__WEBPACK_IMPORTED_MODULE_2___default.a.router.query.id); // const tag = this.props.match.params.tag;
    // const query = queryString.parse(this.props.location.search);

    const url = "https://mineru98.github.io/static/posts/2019-01-07-01-First-post.md";
...
//# sourceMappingURL=[id].js.80016f495da1cbab21d1.hot-update.js.map